...
public class OutboxFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, MessagesAdapter.MessageAdapterListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new MessagesAdapter(activity, messages, this, true);
    ...
    private void getOutbox() {
        String url = ApiEndPoints.GET_OUTBOX
        ...
        ApiHelper api = new ApiHelper(activity, url, Request.Method.GET, new ApiCallback() {
            ...
            public void onSuccess(Object response) {
                ...
                try {
                    JSONArray mailArray = obj.optJSONArray("Outbox");
